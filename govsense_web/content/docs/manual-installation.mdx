...
description: Setting up GovSense manually for customized deployments (Preferred)
---

# Manual Installation (Preferred)

This guide provides step-by-step instructions for setting up GovSense without Docker. This approach gives you more control over the installation process and allows for customization of the environment.
...
The backend is the core of GovSense. Follow these steps to set it up:
...
```bash
# Make sure you're in the govsense_backend directory
cd govsense_backend
...
The GovSense browser extension allows you to save any webpage, including those protected behind authentication.
...
| ENV VARIABLE              | DESCRIPTION                                           |
| ------------------------- | ----------------------------------------------------- |
| PLASMO_PUBLIC_BACKEND_URL | GovSense Backend URL (e.g., `http://127.0.0.1:8000`) |
...
Load the extension in your browser's developer mode and configure it with your GovSense API key.
...
Now that you have GovSense running locally, you can explore its features:
