---
title: Linear
description: Connect your Linear workspace to GovSense
---

# Linear OAuth Integration Setup Guide

This guide walks you through setting up a Linear OAuth integration for GovSense.
...
| **Application name** | `GovSense` |
| **Developer name** | `GovSense` |
| **Developer URL** | `https://www.govsense.com/` |
...
## Running GovSense with Linear Connector
