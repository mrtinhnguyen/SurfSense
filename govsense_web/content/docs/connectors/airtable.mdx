---
title: Airtable
description: Connect your Airtable bases to GovSense
---

# Airtable OAuth Integration Setup Guide

This guide walks you through setting up an Airtable OAuth integration for GovSense.
...
The preview shows what users will see when authorizing GovSense:
...
## Running GovSense with Airtable Connector
