---
title: Obsidian
description: Connect your Obsidian vault to GovSense
---

# Obsidian Integration Setup Guide

This guide walks you through connecting your Obsidian vault to GovSense for note search and AI-powered insights.

<Callout type="warn">
    This connector requires direct file system access and only works with self-hosted GovSense installations.
</Callout>
...
Add your vault as a volume mount to the GovSense backend service:
...
- Check file permissions: GovSense needs read access to the vault directory
