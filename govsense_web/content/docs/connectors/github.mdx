---
title: GitHub
description: Connect your GitHub repositories to GovSense
---

# GitHub Integration Setup Guide

This guide walks you through connecting your GitHub repositories to GovSense for code search and AI-powered insights.
...
1. Go to [GitHub's token creation page](https://github.com/settings/tokens/new?description=govsense&scopes=repo) (pre-filled with `repo` scope)
2. Set an expiration
