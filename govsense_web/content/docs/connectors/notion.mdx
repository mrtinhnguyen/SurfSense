---
title: Notion
description: Connect your Notion workspaces to GovSense
---

# Notion OAuth Integration Setup Guide

This guide walks you through setting up a Notion OAuth integration for GovSense.
...
Notion's API has limitations on certain block types that cannot be retrieved. GovSense will automatically skip these unsupported blocks and continue syncing all other content.
...
## Running GovSense with Notion Connector
