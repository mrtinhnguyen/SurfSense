---
title: Gmail
description: Connect your Gmail to GovSense
---

# Gmail OAuth Integration Setup Guide

This guide walks you through setting up a Google OAuth 2.0 integration for GovSense to connect your Gmail account.
...
## Running GovSense with Gmail Connector
