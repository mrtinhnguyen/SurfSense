...
description: Connect your Google Calendar to GovSense
---

# Google Calendar OAuth Integration Setup Guide

This guide walks you through setting up a Google OAuth 2.0 integration for GovSense to connect your Google Calendar.
...
## Running GovSense with Google Calendar Connector
