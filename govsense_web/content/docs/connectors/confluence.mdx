---
title: Confluence
description: Connect your Confluence spaces to GovSense
---

# Confluence OAuth Integration Setup Guide

This guide walks you through setting up an Atlassian OAuth 2.0 (3LO) integration for GovSense to connect your Confluence spaces.
...
## Running GovSense with Confluence Connector
