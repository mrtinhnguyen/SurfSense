...
description: Connect your Microsoft Teams to GovSense
---

# Microsoft Teams OAuth Integration Setup Guide

This guide walks you through setting up a Microsoft Teams OAuth integration for GovSense using Azure App Registration.
...
4. Enter a description (e.g., `GovSense`) and select an expiration period
5. Click **"Add"**
...
## Running GovSense with Microsoft Teams Connector
