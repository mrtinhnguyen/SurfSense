---
title: Discord
description: Connect your Discord servers to GovSense
---

# Discord OAuth Integration Setup Guide

This guide walks you through setting up a Discord OAuth integration for GovSense.
...
3. Enter the application name: `GovSense`
4. Click **"Create"**
...
<Callout type="warn">
   Keep **Public Client** disabled (off) since GovSense uses a server to make requests.
</Callout>
...
## Running GovSense with Discord Connector
