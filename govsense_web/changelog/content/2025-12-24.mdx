---
title: "GovSense v0.0.9 - Introducing the Agentic Architecture"
description: "GovSense v0.0.9 introduces a new agentic architecture with intelligent source selection, temporal query understanding, and MCP compatibility."
date: "2025-12-24"
...
This release introduces the **GovSense Agent**, a shift from pre-determined workflows (DAG) to dynamic, LLM-driven decision making.
...
GovSense is an AI-powered federated search solution that connects all your knowledge sources in one place.

🎄 Merry Christmas from the GovSense team!