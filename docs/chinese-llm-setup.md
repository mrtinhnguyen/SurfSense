...
本指南将帮助你在 GovSense 中配置和使用国产大语言模型。

This guide helps you configure and use Chinese LLM providers in GovSense.

---

## 📋 支持的提供商 | Supported Providers

GovSense 现已支持以下国产 LLM：
...
- 💬 [GitHub Issues](https://github.com/MODSetter/GovSense/issues)
