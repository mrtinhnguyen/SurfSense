"""Tools registry for GovSense deep agent.

This module provides a registry pattern for managing tools in the GovSense agent.
...
BUILTIN_TOOLS: list[ToolDefinition] = [
    ...
    ToolDefinition(
        name="search_govsense_docs",
        description="Search GovSense documentation for help with using the application",
        factory=lambda deps: create_search_govsense_docs_tool(
            db_session=deps["db_session"],
        ),
        requires=["db_session"],
    ),
