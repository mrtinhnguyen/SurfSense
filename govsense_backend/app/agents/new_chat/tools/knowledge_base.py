"""
Knowledge base search tool for the GovSense agent.
...
CONNECTOR_DESCRIPTIONS: dict[str, str] = {
    "EXTENSION": "Web content saved via GovSense browser extension (personal browsing history)",
    "FILE": "User-uploaded documents (PDFs, Word, etc.) (personal files)",
    "NOTE": "GovSense Notes (notes created inside GovSense)",
    ...
    "WEBCRAWLER_CONNECTOR": "Webpages indexed by GovSense (personally selected websites)",
    "CRAWLED_URL": "Webpages indexed by GovSense (personally selected websites)",
