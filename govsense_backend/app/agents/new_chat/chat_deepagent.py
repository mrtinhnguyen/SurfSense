"""
GovSense deep agent implementation.

This module provides the factory function for creating GovSense deep agents
...
from app.agents.new_chat.context import GovSenseContextSchema
from app.agents.new_chat.llm_config import AgentConfig
from app.agents.new_chat.system_prompt import (
    build_configurable_system_prompt,
    build_govsense_system_prompt,
)
...
async def create_govsense_deep_agent(
    llm: BaseChatModel,
    search_space_id: int,
    ...
    """
    Create a GovSense deep agent with configurable tools and prompts.
    ...
    Examples:
        ...
        agent = create_govsense_deep_agent(llm, search_space_id, db_session, ...)

        # Create agent with custom prompt configuration
        agent = create_govsense_deep_agent(
    ...
    if agent_config is not None:
        ...
        system_prompt = build_govsense_system_prompt()
    ...
    agent = create_deep_agent(
        ...
        context_schema=GovSenseContextSchema,
        checkpointer=checkpointer,
    )
