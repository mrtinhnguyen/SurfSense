"""
GovSense New Chat Agent Module.

This module provides the GovSense deep agent with configurable tools
...
# Agent factory
from .chat_deepagent import create_govsense_deep_agent

# Context
from .context import GovSenseContextSchema
