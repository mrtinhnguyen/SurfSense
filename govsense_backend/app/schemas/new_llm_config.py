...
class NewLLMConfigBase(BaseModel):
    ...
    system_instructions: str = Field(
        default="",
        description="Custom system instructions. Empty string uses default GOVSENSE_SYSTEM_INSTRUCTIONS.",
    )
...
class DefaultSystemInstructionsResponse(BaseModel):
    ...
    default_system_instructions: str = Field(
        ..., description="The default GOVSENSE_SYSTEM_INSTRUCTIONS template"
    )
