...
class VercelStreamingService:
    ...
    def format_terminal_info(self, text: str, message_type: str = "info") -> str:
        """
        Format terminal info as custom data (GovSense specific).
    ...
    def format_further_questions(self, questions: list[str]) -> str:
        """
        Format further questions as custom data (GovSense specific).
    ...
    def format_thinking_step(
        ...
        """
        Format a thinking step for chain-of-thought display (GovSense specific).
    ...
    def format_thread_title_update(self, thread_id: int, title: str) -> str:
        """
        Format a thread title update notification (GovSense specific).
