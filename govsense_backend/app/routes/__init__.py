...
from .govsense_docs_routes import router as govsense_docs_router
from .teams_add_connector_route import router as teams_add_connector_router
from .tthc_routes import router as tthc_router
...
router.include_router(govsense_docs_router)  # GovSense documentation for citations
...
router.include_router(tthc_router)  # TTHC (Thủ tục hành chính) management
